...
namespace Whisparr3.Net.Model
{
    ...
    public partial class ImportListConfigResource : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ImportListConfigResource(Option<int?> id = default, Option<string?> listSyncLevel = default)
        {
            IdOption = id;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> ListSyncLevelOption { get; private set; }

        /// <summary>
        /// Gets or Sets ListSyncLevel
        /// </summary>
        [JsonPropertyName("listSyncLevel")]
        public string? ListSyncLevel { get { return this.ListSyncLevelOption.Value; } set { this.ListSyncLevelOption = new(value); } }
    ...
    public partial class ImportListConfigResourceJsonConverter : JsonConverter<ImportListConfigResource>
    {
        ...
        public override ImportListConfigResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> listSyncLevel = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "id":
                            ...
                            break;
                        case "listSyncLevel":
                            listSyncLevel = new Option<string?>(utf8JsonReader.GetString());
                            break;
                        default:
                            break;
                    }
            ...
            return new ImportListConfigResource(id, listSyncLevel);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, ImportListConfigResource importListConfigResource, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (importListConfigResource.ListSyncLevelOption.IsSet)
                if (importListConfigResource.ListSyncLevelOption.Value != null)
                    writer.WriteString("listSyncLevel", importListConfigResource.ListSyncLevel);
                else
                    writer.WriteNull("listSyncLevel");
        }
    }
}
