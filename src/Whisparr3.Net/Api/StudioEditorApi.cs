...
namespace Whisparr3.Net.Api
{
    ...
    /// </summary>
    public interface IStudioEditorApi : IApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class StudioEditorApiEvents
    {
        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnPutStudioEditor;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorPutStudioEditor;

        internal void ExecuteOnPutStudioEditor(StudioEditorApi.PutStudioEditorApiResponse apiResponse)
        {
            OnPutStudioEditor?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }

        internal void ExecuteOnErrorPutStudioEditor(Exception exception)
        {
            OnErrorPutStudioEditor?.Invoke(this, new ExceptionEventArgs(exception));
        }
    }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class StudioEditorApi : IStudioEditorApi
    {
        ...
        /// The logger
        /// </summary>
        public ILogger<StudioEditorApi> Logger { get; }
        ...
        /// The class containing the events
        /// </summary>
        public StudioEditorApiEvents Events { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StudioEditorApi"/> class.
        /// </summary>
        /// <returns></returns>
        public StudioEditorApi(ILogger<StudioEditorApi> logger, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, StudioEditorApiEvents studioEditorApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            Logger = logger;
            HttpClient = httpClient;
            Events = studioEditorApiEvents;
        ...
        public async Task<IPutStudioEditorApiResponse?> PutStudioEditorOrDefaultAsync(Option<StudioEditorResource> studioEditorResource = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await PutStudioEditorAsync(studioEditorResource, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        public async Task<IPutStudioEditorApiResponse> PutStudioEditorAsync(Option<StudioEditorResource> studioEditorResource = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ValidatePutStudioEditor(studioEditorResource);

                FormatPutStudioEditor(studioEditorResource);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    {
                        PutStudioEditorApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(Logger, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/api/v3/studio/editor", requestedAtLocalVar, _jsonSerializerOptions);

                                break;
                            }
                        }

                        AfterPutStudioEditorDefaultImplementation(apiResponseLocalVar, studioEditorResource);

                        Events.ExecuteOnPutStudioEditor(apiResponseLocalVar);
            ...
            {
                OnErrorPutStudioEditorDefaultImplementation(e, "/api/v3/studio/editor", uriBuilderLocalVar.Path, studioEditorResource);
                Events.ExecuteOnErrorPutStudioEditor(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="PutStudioEditorApiResponse"/>
        /// </summary>
        public partial class PutStudioEditorApiResponse : Whisparr3.Net.Client.ApiResponse, IPutStudioEditorApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            public PutStudioEditorApiResponse(ILogger<StudioEditorApi> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
