...
namespace Whisparr3.Net.Api
{
    ...
    /// </summary>
    public interface IPingApi : IApi
    {
        /// <summary>
        /// The class containing the events
        /// </summary>
        PingApiEvents Events { get; }
        ...
        Task<IGetPingApiResponse> GetPingAsync(System.Threading.CancellationToken cancellationToken = default);
    ...
    /// </summary>
    public interface IGetPingApiResponse : Whisparr3.Net.Client.IApiResponse, IOk<Whisparr3.Net.Model.PingResource?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IHeadPingApiResponse : Whisparr3.Net.Client.IApiResponse, IOk<Whisparr3.Net.Model.PingResource?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class PingApiEvents
    {
        /// <summary>
        /// The event raised after the server response
        /// </summary>
        public event EventHandler<ApiResponseEventArgs>? OnGetPing;

        /// <summary>
        /// The event raised after an error querying the server
        /// </summary>
        public event EventHandler<ExceptionEventArgs>? OnErrorGetPing;

        internal void ExecuteOnGetPing(PingApi.GetPingApiResponse apiResponse)
        {
            OnGetPing?.Invoke(this, new ApiResponseEventArgs(apiResponse));
        }
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public sealed partial class PingApi : IPingApi
    {
        ...
        /// The class containing the events
        /// </summary>
        public PingApiEvents Events { get; }
        ...
        /// </summary>
        /// <returns></returns>
        public PingApi(ILogger<PingApi> logger, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, PingApiEvents pingApiEvents,
            TokenProvider<ApiKeyToken> apiKeyProvider)
        {
            _jsonSerializerOptions = jsonSerializerOptionsProvider.Options;
            Logger = logger;
            HttpClient = httpClient;
            Events = pingApiEvents;
        ...
        private void AfterGetPingDefaultImplementation(IGetPingApiResponse apiResponseLocalVar)
        {
            bool suppressDefaultLog = false;
            AfterGetPing(ref suppressDefaultLog, apiResponseLocalVar);
        ...
        /// <param name="apiResponseLocalVar"></param>
        partial void AfterGetPing(ref bool suppressDefaultLog, IGetPingApiResponse apiResponseLocalVar);
        ...
        private void OnErrorGetPingDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetPing(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar);
        ...
        /// <param name="pathFormatLocalVar"></param>
        /// <param name="pathLocalVar"></param>
        partial void OnErrorGetPing(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetPingApiResponse"/>&gt;</returns>
        public async Task<IGetPingApiResponse?> GetPingOrDefaultAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetPingAsync(cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetPingApiResponse"/>&gt;</returns>
        public async Task<IGetPingApiResponse> GetPingAsync(System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    {
                        GetPingApiResponse apiResponseLocalVar;
            ...
            {
                OnErrorGetPingDefaultImplementation(e, "/ping", uriBuilderLocalVar.Path);
                Events.ExecuteOnErrorGetPing(e);
                throw;
            }
        }

        /// <summary>
        /// The <see cref="GetPingApiResponse"/>
        /// </summary>
        public partial class GetPingApiResponse : Whisparr3.Net.Client.ApiResponse, IGetPingApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public Whisparr3.Net.Model.PingResource? Ok()
            {
                bool suppressDefault = false;
                Whisparr3.Net.Model.PingResource? result = null;
            ...
            private Whisparr3.Net.Model.PingResource? DefaultOk()
            {
                // NOTICE: Consider this AsModel template deprecated. Implement the appropriate partial method instead
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<Whisparr3.Net.Model.PingResource>(RawContent, _jsonSerializerOptions)
                    : null;
            }

            partial void OnOk(ref bool suppressDefault, ref Whisparr3.Net.Model.PingResource? result);
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out Whisparr3.Net.Model.PingResource? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class HeadPingApiResponse : Whisparr3.Net.Client.ApiResponse, IHeadPingApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
